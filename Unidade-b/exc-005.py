...
Jubisvaldo = Estudante("Jubisvaldo", 19, 7.9,"001")
Carol = Estudante("Carol", 30, 9,"002")
Juze = Estudante("Juze", 16, 9.6,"003")
Pedrim = Estudante("Pedrim", 20, 8,"004")

ltp1 = Turma_Estudantes()

ltp1.adicionar_estudante(Jubisvaldo)
ltp1.adicionar_estudante(Carol)
ltp1.adicionar_estudante(Juze)
ltp1.adicionar_estudante(Pedrim)
...
print(ltp1.media_da_turma())
print(ltp1.informacoes(Pedrim))
Carol.alterar_nota(10)
print(ltp1.informacoes(Carol))
print(ltp1.melhor_estudante())