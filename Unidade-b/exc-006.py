...
caca_niqueis = Jogo("Caça-níqueis da Sorte", "Caça-níqueis", 8.00, "001")
roleta = Jogo("Roleta Premium", "Mesa de Jogo", 10.00, "002")
poker_online = Jogo("Poker Texas Hold'em", "Mesa de Jogo", 18.00, "003")
blackjack = Jogo("Blackjack VIP", "Mesa de Jogo", 16.00, "004")
bingo_online = Jogo("Bingo da Sorte", "Bingo", 6.00, "005")
